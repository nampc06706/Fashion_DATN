          ...
          <div className="xl:h-full mb-20 xl:mb-0 w-full relative">
            <SimpleSlider settings={settings} selector={sliderRef}>
              <div className="item w-full xl:h-[733px] h-[500px]">
                <div className="w-full h-full relative md:bg-center bg-white">
                  {/* Chèn video YouTube mà không cho phép phóng to hoặc tương tác */}
                  <iframe
                    width="100%"
                    height="100%"
                    src="https://www.youtube.com/embed/uqs7-46ny9Y?controls=0&modestbranding=1&rel=0&showinfo=0&disablekb=1&fs=0&autoplay=1&loop=1&playlist=uqs7-46ny9Y&vq=hd1080"
                    frameBorder="0"
