...
function ProductCardStyleThree({ datas }) {
  ...
  const formattedPrice = datas.price ? `${Math.round(datas.price).toLocaleString("vi-VN")} ₫` : "N/A";
  ...
  return (
    <div className="product-cart-three w-full group">
      ...
      <div className="flex flex-col items-center">
        ...
        <p className="text-base font-medium text-qgraytwo text-center">
          {formattedPrice}
        </p>
      </div>
    </div>
